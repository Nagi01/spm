...
QWidget *Qt_toolBox::makeVideoTab()
{
	...
	sliderTime->setTickPosition(QSlider::TicksBelow);
	sliderTime->setTickInterval(1);
	connect(sliderTime, SIGNAL(sliderMoved(int)), this, SLOT(moveTimeSlider(int)));

	QLabel *surgicalprocess = new QLabel(tr("Px"));
	surgicalprocess->setFixedHeight(10);
	...
	vbox->addWidget(surgicalprocess);
